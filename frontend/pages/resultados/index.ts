...
export class ResultadoAnfitrion extends HTMLElement {
    connectedCallback() {
        this.render();
    }
    render() {
    ...
    <div class="container">
        ...
        buttonBack.addEventListener("click", () => {
            state.jugada("anfitrion", "ninguna");
            Router.go("/ang_anfitrion");
        });
...
customElements.define("resultados-web", ResultadoAnfitrion);
